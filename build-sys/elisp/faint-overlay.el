...
(defun def-text (def)
  ;; Get the text from a def entry
  (cdddr def))


(defun def-file (def)
  ;;; Get the file for a def entry
  (cadr def))


(defun def-char (def)
  ;;; Get the character number of the def entry
