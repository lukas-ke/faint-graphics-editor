#include "tests/benchmarks/gen/defines.hh"

#if defined(TEST_PLATFORM_LINUX)
// Linux benchmark runner:
// On Linux, I need to initialize a wxApp, or I get
// gtk errors when running bench-gaussian-blur (probably due to
// dependence to certain wxWidgets features)
//
...
public:
  int MainLoop() override{
    return run_benchmarks(this->argc, this->argv);
  }
